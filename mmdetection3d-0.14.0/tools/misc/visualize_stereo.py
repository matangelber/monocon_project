...
def main(new_coco_json=None):
    ...
    if getattr(dataset, 'show', None) is not None:
        ...
        if eval_pipeline:
            dataset.show_stereo(max_images_to_show=args.max_images, output_dir=args.output_dir, show=args.show,
                         pipeline=eval_pipeline)

        else:
            dataset.show_stereo(max_images_to_show=args.max_images, output_dir=args.output_dir,
