...
os.chdir(tools_path)
from tools.misc.visualize_offset_results import main as vis_offset_results
from json_tools import filter_json
# Adding arguments dynamically

def visualize_offset_results_wrapper(config_file, results, output_dir="", show=False, filtered_file_names=[]):
    ...
    vis_offset_results(new_json_filepath)
...
if __name__ == '__main__':
    ...
    visualize_offset_results_wrapper(config_file, results, output_dir, show, filtered_file_names)
